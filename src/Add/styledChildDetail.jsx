...
export const ChildIcon = styled.div`
  width: 20px;
  height: 20px;
  background-image: url('/images/OnChildIcon.svg');
...
export const PetIcon = styled.div`
  width: 20px;
  height: 20px;
  background-image: url('/images/OnPetIcon.svg');
  background-size: cover; //이미지 안잘리게
`;
...
// 등하원 기관 아이콘
export const InstitutionIcon = styled.div`
  width: 20px;
  height: 20px;
